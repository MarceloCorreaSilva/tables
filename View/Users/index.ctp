<div class="users">
	...
	<tr controller="<?php 
		...
		<td data-th="ID" ><?php echo h($user['User']['id']); ?></td>
		<td data-th="Nome" column='nome'><?php 
				echo $this->Html->link(
					$user['User']['nome'], 
					array('action' => 'view', $user['User']['id'])
				); 
		?></td>
		<td data-th="Idade" column='idade'><?php echo h($user['User']['idade']); ?>&nbsp;</td>
		<td data-th="E-mail" column='email'><?php echo h($user['User']['email']); ?>&nbsp;</td>
